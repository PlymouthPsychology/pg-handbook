...
To access it you will need an account on this machine (unfortunately for 2018
this will be a different account and password to your university login).
...
-   Joanna Triplet is the specialist librarian for Psychology
    ([Joanna Triplet](mailto:joanna.triplett@plymouth.ac.uk)) and may be able to
...
-   If you are finding it hard to access particular items, then please give the
    ...
    [Joanna Triplett](mailto:joanna.triplett@plymouth.ac.uk), who will
    investigate.
...
-   From 2018 Psychology students may use the new Psych:EL space, on the third
    floor of the link building, when formal teaching is not scheduled.

-   Psychology students may also use Link 106 and 106 when no teaching is
...
-   The library has many computers available on the ground floor, and bookable
    rooms for quiet study.
...
checked on-line at https://www.psy.plymouth.ac.uk/PsyStudyRoom/default.aspx

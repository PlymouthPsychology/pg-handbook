...
All assessment on the PRM is based upon coursework, and we have no formal
...
> [masters_coursework_template.dotx](static/templates/masters_coursework_template_2018_v1.dotx)
...
and masters courses, including the PRM and final year of the MPsych, are at
...
Marked coursework will be returned via the DLE, within 20 days of submission. If
there is a reason for a delay you will be informed; if you notice a delay,
please inform the programme lead.
...
each module. You will then receive a statement of your results in July (which

...
The project counts for 40 credits out of a total of 180 for the MSc CP as a 
whole, or 40 out of 120 credits for the MPsych CP, and is thus a very 
...
work will be of considerable interest to potential employers, PhD supervisors
...
CP students are given 40 points within our research participation pool. More
...
CP students also have a project budget of £120 which can be used to pay
participants.
...
Students will be conducting service evaluation projects OR empirical rojects with non-clinical samples so NHS ethical
clearance will not be required.  

### Work with children or vulnerable adults

Research with children or vulnerable adults recruited through specific institutions (e.g., Schools)
will need, in addition to the ethical clearance from the School, the approval
of the authorities in charge of the institution.
...
Method : The methods section should demonstrate
    ...
    - Level of ambition in terms of both the scale of the study and the relative complexity of the methodology employed. 
...
Discussion : A discussion should show:
    ...
    - Implications for clinical practice or service delivery.
...
but as a minimum we would expect CP students to submit:
